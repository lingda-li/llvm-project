  ...
  struct MapInfo {
    ...
    MapInfo(
        ...
        : Components(Components), MapType(MapType), MapModifiers(MapModifiers),
          ...
          ForDeviceAddr(ForDeviceAddr), Mapper(Mapper) {}
  };
    ...
    auto &&InfoGen =
        [&Info](const ValueDecl *D,
          ...
          Info[VD].emplace_back(L, MapType, MapModifiers, ReturnDevicePointer,
                                IsImplicit, ForDeviceAddr, Mapper);
        };
      ...
      if (CI != DeferredInfo.end()) {
        for (const DeferredDevicePtrEntryTy &L : CI->second) {
          ...
          if (L.ForDeviceAddr) {
            ...
            CurInfo.CurTypes.push_back(OMP_MAP_RETURN_PARAM |
                                       OMP_MAP_MEMBER_OF);
          } else {
            ...
            // correct value of MEMBER_OF.
            CurInfo.CurTypes.push_back(
                OMP_MAP_PTR_AND_OBJ | OMP_MAP_RETURN_PARAM | OMP_MAP_MEMBER_OF);
          }
          CurInfo.CurBasePointers.emplace_back(BasePtr, L.VD);
          CurInfo.CurPointers.push_back(Ptr);
          CurInfo.CurSizes.push_back(
